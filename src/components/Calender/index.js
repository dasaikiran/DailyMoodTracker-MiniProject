    ...
    dates: [
      {
        ...
        date: '01',
        emojiUrl: 'https://assets.ccbp.in/frontend/react-js/monthly-emojis/monthly-emojis-very-happy.png',
        emojiName: '',
      },
      {
    ...
    return (
      <>
        <div className="arrow-container">
          <button onClick={this.onLeftArrowClick} className="arrow-button">
            <MdOutlineKeyboardArrowLeft className="arrow-icon" />
          </button>
          <p className="month-para">{initialMonthsList[month - 1].monthName}</p>
          <button onClick={this.onRightArrowClick} className="arrow-button">
